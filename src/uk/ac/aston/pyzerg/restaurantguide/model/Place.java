...
/**
 * This is a Java Bean for Google Places API. 
 * 
 * In practice, this is terrible design principle because the getters/setters do not provide 
 * any additional functionality, e.g. validation. They only bloat the class.
 * 
 * 
 * All fields should really be public instead. */
